...
**Y: og OneDrive skal være identiske — også gitignoreret Input/Output med persondata og repos uden
remote** (JST 2026-09-15). Udgiv sørger for det; Y:-klonerne står dog altid på `main`.
